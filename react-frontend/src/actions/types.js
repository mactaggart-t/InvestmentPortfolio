...
export const IND_SUBMIT_TICKERS = 'IND_SUBMIT_TICKERS';
export const PORT_TICKERS_RETRIEVED = 'PORT_TICKERS_RETRIEVED';
export const FORMAT_DATA_IND = 'FORMAT_DATA_IND';
export const RESET_LOAD = 'RESET_LOAD';
export const SEC_DIV_RETRIEVED = 'SEC_DIV_RETRIEVED';
export const SECTOR_DIV_RETRIEVED = 'SECTOR_DIV_RETRIEVED';
