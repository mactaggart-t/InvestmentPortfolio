(function (global, factory) {
  ...
  // Shared empty execution context when generating oldStatic styles
   ...
   * }
   *
   * The second ampersand should be a reference to the oldStatic component class. stylis
   * has no knowledge of oldStatic class so we have to intelligently replace the base selector.
   */
  ...
  var StyleSheet = function () {
    ...
    StyleSheet.prototype.rehydrate = function rehydrate$$1() {
      ...
      for (var i = 0; i < nodesSize; i += 1) {
        ...
        /* index original HTMLStyleElement */
        els.push(el);
      }
  ...
  function isStaticRules(rules, attrs) {
    for (var i = 0; i < rules.length; i += 1) {
      ...
      if (Array.isArray(rule) && !isStaticRules(rule, attrs)) {
        ...
        // functions are allowed to be oldStatic if they're just being
  ...
  */
  ...
  var StyledComponent = function (_Component) {
    ...
    StyledComponent.prototype.renderOuter = function renderOuter() {
      ...
      // No need to subscribe a oldStatic component to theme changes, it won't change anything
