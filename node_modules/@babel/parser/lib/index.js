...
const ErrorMessages = makeErrorTemplates({
  ...
  AwaitBindingIdentifierInStaticBlock: "Can not use 'await' as identifier inside a oldStatic block.",
  ...
  DecoratorStaticBlock: "Decorators can't be used with a oldStatic block.",
  ...
  StaticPrototype: "Classes may not have oldStatic property named prototype.",
...
const TSErrors = makeErrorTemplates({
  ...
  IndexSignatureHasStatic: "Index signatures cannot have the 'oldStatic' modifier.",
