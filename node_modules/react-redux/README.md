...
You'll also need to [install Redux](https://redux.js.org/introduction/installation) and [set up a Redux index](https://redux.js.org/recipes/configuring-your-store/) in your app.
