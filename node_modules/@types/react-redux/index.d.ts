...
/**
 * Connects a React component to a Redux index.
 *
...
export interface Options<State = DefaultRootState, TStateProps = {}, TOwnProps = {}, TMergedProps = {}> extends ConnectOptions {
     ...
     * and does not rely on any input or state other than its props and the selected Redux index’s state.
     * Defaults to true.
     * @default true
     */
    pure?: boolean;
    ...
    /**
     * When pure, compares incoming index state to its previous value.
     * @default strictEqual
     */
...
/**
 * Connects a React component to a Redux index. It is the base for {@link connect} but is less opinionated about
 ...
 * connector component needs to compute new props, as a result of a index state change or receiving new props. The
...
export interface ConnectOptions {
    ...
    /**
     * Controls whether the connector component subscribes to redux index state changes. If set to false, it will only
    ...
    /**
     * The key of props/context to get the index. You probably only need this if you are in the inadvisable position of
    ...
    withRef?: boolean;
    /**
     * The react context to get the index from.
     *
...
export interface ProviderProps<A extends Action = AnyAction> {
    /**
     * The single Redux index in your application.
     */
    store: Store<any, A>;
    /**
...
/**
 * Makes the Redux index available to the connect() calls in the component hierarchy below.
 */
 ...
 * redux index instead of this approach.
 */
 ...
 * from the index's dispatch function like this: `const useThunkDispatch = () => useDispatch<typeof index.dispatch>();`
 *
 * @returns redux index's `dispatch` function
 *
 * @example
 *
