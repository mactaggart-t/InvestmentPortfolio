...
Main features
-------------
:sparkles: Synchronize router state with redux index through uni-directional flow (i.e. history -> index -> router -> components).
...
...
const index = configureStore(/* provide initial state if any */)
...
...
      <Provider index={store} context={ReactReduxContext}>
