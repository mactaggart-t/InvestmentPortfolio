...
var createConnectedRouter = function createConnectedRouter(structure) {
   ...
   * When history is changed, it dispatches action to redux index.
   * Then, index will pass props to component to render.
   * This creates uni-directional flow from history->index->router->components.
   */
  ...
  var ConnectedRouter = /*#__PURE__*/function (_PureComponent) {
    ...
    function ConnectedRouter(props) {
      ...
      _this.inTimeTravelling = false; // Subscribe to index changes to check if we are in time travelling
      ...
      _this.unsubscribe = store.subscribe(function () {
        ...
        // index may be unmounted, a navigation occurs, and then the index is re-mounted
        ...
        var isTimeTravelDebuggingAllowed = !props.noTimeTravelDebugging; // Extract index's location
        ...
        var _history$location = history.location,
            ...
            stateInHistory = _history$location.state; // If we do time travelling, the location in index is changed but location in history is not changed
        ...
        if (isTimeTravelDebuggingAllowed && props.history.action === 'PUSH' && (pathnameInHistory !== pathnameInStore || searchInHistory !== searchInStore || hashInHistory !== hashInStore || !isEqualWith(stateInStore, stateInHistory, stateCompareFunction))) {
          _this.inTimeTravelling = true; // Update history's location to match index's location
